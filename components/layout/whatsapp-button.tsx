  ...
  return (
    <motion.a
      ...
      className={cn(
        ...
        "ring-4 ring-white/90 dark:ring-zinc-950/90",
        "transition-shadow hover:shadow-xl hover:shadow-[#25D366]/40",
        "right-4 bottom-[max(1rem,env(safe-area-inset-bottom))] h-12 w-12",
        "sm:right-5 sm:bottom-[max(1.25rem,env(safe-area-inset-bottom))] sm:h-14 sm:w-14",
